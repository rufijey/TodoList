...
exports.getVerificationEmailTemplate = exports.getShareNotificationTemplate = void 0;
const clean = (str) => {
    return str
        .split('\n')
        .map((line) => line.trim())
...
const getShareNotificationTemplate = (ownerEmail, listName, permission, shareUrl) => {
...
exports.getShareNotificationTemplate = getShareNotificationTemplate;
